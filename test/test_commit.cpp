...
int main() {
        std::cout<<std::endl<<"------ TEST COMMAND:     ./a.out init  && ./a.out stage stuff.cpp  && ./a.out commit test  && ./a.out status        ------"<<std::endl;
 ...
 char* argv4[3] = {"./a.out","commit","test"};
 ...
 Command * command4 = new commitCommand(2,argv4+1);
